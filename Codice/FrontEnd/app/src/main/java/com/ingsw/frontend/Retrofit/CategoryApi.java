...
public interface CategoryApi {
    ...
    @PUT("/category/update")
    Completable update(@Body Category category);
    ...
    @GET("/category/get/{id}/order")
    Single<List<Category>> getCategoryByMenuIdOrderByAlimentAndPosition(@Path("id") Integer id);
}
